local assets =
{
	Asset( "ANIM", "anim/uzi_bullet.zip" ),
}
...
local function fn()
	...
	inst.AnimState:SetBank("uzi_bullet")
	inst.AnimState:SetBuild("uzi_bullet")
	inst.AnimState:PlayAnimation("idle")
	
	inst:AddTag("sharp")
	inst:AddTag("pointy")
	inst:AddTag("uzi_bullet")
	...
	inst.components.weapon:SetDamage(TUNING.UZI_BULLET_DAMAGE)
...
return Prefab("uzi_bullet", fn, assets)
